...
const Plan = injectIntl(({ id, highlighted, opened, onOpen, intl }) => (
  <div
    className={`section is-fullheight${
      highlighted ? " has-background-grey-lighter" : " has-background-light"
    }`}
  >
    <div className="has-text-centered">
      ...
      <Price
        amount={intl.formatMessage({ id: `components.plans.${id}.price` })}
      />
      <br />
      <div className="is-hidden-touch">
        <Link
          className={`button is-primary has-text-weight-bold is-radiusless is-medium${
            highlighted ? "" : " is-outlined"
          }`}
      ...
      <div className="columns is-multiline">
        ...
        <div className="is-selected column is-4-desktop is-12-mobile is-4-tablet">
          <Plan
            highlighted
            id="intermediate"
            opened={openedPlans.intermediate}
            onOpen={onOpen}
          />
        </div>
        <div className="column is-4-desktop is-12-mobile is-4-tablet">
