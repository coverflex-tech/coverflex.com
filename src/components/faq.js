...
const QuestionTitle = ({ copy }) => (
  <p
    className="is-size-5"
    style={{ "border-bottom": "1px solid #F0814D", padding: "1rem 0" }}
  >
    {copy}
  </p>
)
...
const QuestionAnswer = ({ copy }) => (
  <p style={{ "padding-top": "1rem" }}>
    ...
    aliquet leo ut egestas. Duis et urna sed massa consequat commodo vitae at
    massa. Integer mattis posuere interdum. Ut vitae ante at odio vulputate
    rutrum. Vestibulum ut vulputate metus. Integer posuere a urna ut dignissim.
    Sed enim nisl, consectetur non pellentesque eu, condimentum in turpis. Ut a
    hendrerit ligula.
  </p>
)
...
const Question = ({ titleCopy, answerCopy, parent, childCount }) => (
  <div style={{ "padding-bottom": "64px" }}>
    <a
      href={"#" + parent + "_collapsible-" + childCount}
      data-action="collapse"
    >
      <QuestionTitle copy={titleCopy} />
    </a>
    <div
      id={parent + "_collapsible-" + childCount}
...
class Faq extends Component {
  componentDidMount() {
    const bulmaCollapsible = require("@creativebulma/bulma-collapsible")
